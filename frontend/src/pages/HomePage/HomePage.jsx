    ...
    <div className="contenu">
      ...
      <div className="container1">
        <p className="descriptionJeux">
          ...
          Kirkman. Ce jeu plonge les joueurs dans un univers post-apocalyptique
          où les morts-vivants errent dans un monde ravagé. Concept du Jeu Dans
          "The Walking Dead: All Out War", les joueurs prennent le rôle de
          survivants luttant contre les hordes de zombies, mais aussi contre
          d'autres groupes de survivants. Avec un système de jeu basé sur des
          dés et des cartes, les joueurs doivent gérer leurs ressources,
          planifier leurs mouvements et combattre pour leur survie. Conclusion
          Pour les amateurs de la série et les passionnés de jeux de stratégie,
          "The Walking Dead: All Out War" est un incontournable. Il offre une
